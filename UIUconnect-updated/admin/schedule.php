...
<body>
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor ">
                        <a href="faculty.php" class="non-style-link-menu "><div><p class="menu-text">Students</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <?php
                    if($_POST){
                        ...
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.scheduleid,schedule.title,facultydata.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join facultydata on schedule.docid=facultydata.docid ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,facultydata.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join facultydata on schedule.docid=facultydata.docid  order by schedule.scheduledate desc";
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nop" class="form-label">Number of Studentss/Booking Numbers : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            $sqlmain= "select schedule.scheduleid,schedule.title,facultydata.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join facultydata on schedule.docid=facultydata.docid  where  schedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $docname=$row["docname"];
            $scheduleid=$row["scheduleid"];
