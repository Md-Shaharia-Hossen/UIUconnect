                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="faculty.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Faculty name or Email" list="facalties">&nbsp;&nbsp;
                                    
                                    <?php
                                        echo '<datalist id="faculties">';
                            ...
                            <td width="15%">
                                ...
                                $doctorrow = $database->query("select  * from  facultydata;");
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Upcoming Booking until Next <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Here's Quick access to Upcoming Booking until 7 days<br>
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                            $sqlmain= "select schedule.scheduleid,schedule.title,facultydata.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join facultydata on schedule.docid=facultydata.docid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc"; 
                                                $result= $database->query($sqlmain);
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Booking</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
