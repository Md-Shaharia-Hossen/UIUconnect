...
$bg_color = '#fefbd0';  
    ...
    $sqlmain= "select * from facultydata where docemail=?";
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search12" class="input-text header-searchbar" placeholder="Search Students or Email" list="student">&nbsp;&nbsp;
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Booking ID: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
