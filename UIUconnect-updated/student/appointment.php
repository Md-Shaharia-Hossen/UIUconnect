        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-home" >
                        <a href="student/index.php" class="non-style-link-menu "><div><p class="menu-text">Connect With Faculty</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                            You want to Cancel this Booking?<br><br>
                            Session Name: &nbsp;<b>'.substr($title,0,40).'</b><br>
                            Faculty name&nbsp; : <b>'.substr($docname,0,40).'</b><br><br>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Designation: </label>
