            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-home " >
                        <a href="index.php" class="non-style-link-menu "><div><p class="menu-text">UIUconnect</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Faculties name or Email" list="faculties">&nbsp;&nbsp;
...
?>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $sqlmain = "SELECT * FROM facultydata WHERE docid=?";
            ...
            $stmt = $database->prepare("select sname from designation where id=?");
            ...
            $sqlmain= "select sname from designation where id='?";
            $stmt = $database->prepare($sqlmain);
            $stmt->bind_param("s",$spe);
            $stmt->execute();
            $result = $stmt->get_result();
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Choose Designationss: (Current'.$spcil_name.')</label>
