     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row">
                 <td class="menu-btn menu-icon-appoinment  ">
                     <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">My Time Table</p></a></div>
                 </td>
             </tr>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,facultydata.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join facultydata on schedule.docid=facultydata.docid where facultydata.docid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
